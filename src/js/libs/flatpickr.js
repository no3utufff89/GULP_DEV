...
!(function (e, n) {
        ...
        a = {
            ...
            getWeek: function (e) {
                ...
                return (
                    1 +
                    Math.round(
                        ((n.getTime() - t.getTime()) / 864e5 - 3 + ((t.getDay() + 6) % 7)) / 7
                    )
                );
            },
            hourIncrement: 1,
    ...
    function d(e, n, t) {
        ...
        return (
            (n = n || ''), (t = t || ''), (a.className = n), void 0 !== t && (a.textContent = t), a
        );
    }
    function u(e) {
    ...
    function k(p, v) {
        ...
        function oe(e, n) {
            if (
                ...
                1 === w.selectedDates.length &&
                    (!e ||
                        (e.classList.contains(n) && !e.classList.contains('flatpickr-disabled'))))
            ) {
                for (
