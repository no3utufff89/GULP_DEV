...
class I extends g {
    ...
    onPointerUp(t, e, n) {
        if (n.length)
            return (
                (this.dragOffset.x = 0), (this.dragOffset.y = 0), void (this.trackingPoints = [])
            );
    ...
    setTransform() {
        ...
        for (const n of v) {
            const s = 'e' == n || 'f' === n ? M : T;
            (o[n] = t(e[n], s)),
                Math.abs(i[n] - e[n]) < ('e' == n || 'f' === n ? 0.51 : 0.001) && (e[n] = i[n]);
        }
        let { a: a, b: r, c: l, d: c, e: h, f: d } = o,
            u = `matrix(${a}, ${r}, ${l}, ${c}, ${h}, ${d})`,
            p = n.parentElement instanceof HTMLPictureElement ? n.parentElement : n;
        if ((this.option('transformParent') && (p = p.parentElement || p), p.style.transform === u))
            return;
        p.style.transform = u;
    ...
    updateControls() {
        ...
        if (
            (u &&
                ...
                (t(s.width, 1) > t(s.fitWidth, 1) || t(s.height, 1) > t(s.fitHeight, 1)) &&
                    (p = !0)),
...
class W extends _ {
    ...
    createItem(t = 0) {
        ...
        const s = n(
            this.instance.localize(this.option('dotTpl'), [['%d', t + 1]]).replace(/\%i/g, t + '')
        );
        return (
            i.appendChild(s),
    ...
    addBtn(t) {
        ...
        return (
            ...
            (n.dataset[
                `carousel${
                    ((o = t),
                    o ? (o.match('^[a-z]') ? o.charAt(0).toUpperCase() + o.substring(1) : o) : '')
                }`
            ] = 'true'),
...
class Z extends _ {
    ...
    onNavTouch(t, e, i) {
        ...
        a.slideTo(d),
            r.slideTo(h, {
                friction:
                    (null === (s = null === (n = this.nav) || void 0 === n ? void 0 : n.plugins) ||
                    void 0 === s
                        ? void 0
    ...
    onTargetChange() {
        ...
        const s =
                null ===
                    (e = null === (t = i.pages[i.page]) || void 0 === t ? void 0 : t.slides[0]) ||
                void 0 === e
                    ? void 0
                    : e.index,
...
class Q extends g {
        ...
        (this.panzoom = new I(
            ...
            u(
                {},
                {
                    ...
                    maxVelocity: t =>
                        Math.abs(t.target[this.axis] - t.current[this.axis]) < 2 * this.viewportDim
                            ? 100
                            : 0,
                },
                t
        ...
        if (
            ...
            l && (this.track || document.body).prepend(r),
                (o =
                    ...
                    Math.max(
                        1,
                        (null === (i = window.visualViewport) || void 0 === i ? void 0 : i.scale) ||
                            1
                    ));
    ...
    transitionTo(t = 0, e = this.option('transition')) {
        ...
        let h = t > a ? 1 : -1;
        this.isInfinite &&
            (0 === a && t === r.length - 1 && (h = -1), a === r.length - 1 && 0 === t && (h = 1));
            ...
            for (const i of this.slides) {
                ...
                n &&
                    ...
                    n.classList.contains('f-thumbs__slide')
                        ...
                        ? (n.classList.contains(e) || (P(n, e), this.emit('selectSlide', i)),
                          n.removeAttribute(t))
                        : (n.classList.contains(e) && (S(n, e), this.emit('unselectSlide', i)),
                          n.setAttribute(t, 'true')));
            }
    }
    flipInfiniteTrack() {
    ...
    onDecel(t, e = 0, i = 0, n = 0, s = 0) {
        ...
        Math.abs(d) > 5
            ? (l[u].dim <
                  document.documentElement['client' + (this.isHorizontal ? 'Width' : 'Height')] -
                      1 && (u = g),
    ...
    slideTo(
        t = 0,
        { friction: e = this.option('friction'), transition: i = this.option('transition') } = {}
    ) {
    ...
    updateMetrics() {
        ...
        if (i) {
            let e = Math.max(i[l], t(i.getBoundingClientRect()[r], 1e3)),
                ...
                s = 'padding',
                a = o ? 'Right' : 'Bottom';
            (e -= parseFloat(n[s + (o ? 'Left' : 'Top')]) + parseFloat(n[s + a])),
                (this.viewportDim = e);
        }
        let c,
            h = 0;
    ...
    getProgress(e, i = !1, n = !1) {
        ...
        this.isInfinite &&
            !0 !== n &&
            ((h = t((l - r.pos + a) / (1 * r.dim), 1e3)),
            (d = t((l - r.pos - a) / (1 * r.dim), 1e3)));
...
class Lt extends _ {
    ...
    onUnselectSlide(t, e, i) {
        ...
        if (i.type === Tt) {
            try {
                null ===
                    (s = null === (n = i.el) || void 0 === n ? void 0 : n.querySelector('video')) ||
                    void 0 === s ||
                    s.pause();
            } catch (t) {}
            return;
        ...
        i ||
            ('string' == typeof e &&
                ('#' === e.charAt(0)
                    ...
                    ? ((i = Tt),
                      (t.videoFormat = t.videoFormat || 'video/' + ('ogv' === n[1] ? 'ogg' : n[1])))
                    : e.match(
...
let $t = class extends _ {
    ...
    resizeModernSlide(t) {
        this.isModern &&
            (t[Ht] = t[_t] && t[Nt] ? Math.round(this[Nt] * (t[_t] / t[Nt])) : this[Ht]);
    }
    updateProps() {
        const t = this.container;
        if (!t) return;
...
class Qt extends _ {
    ...
    onClick(t) {
        ...
        if (void 0 !== r.fancyboxToggleSlideshow) {
            ...
            let s = e.isActive;
            return (
                o && 'mousemove' === o.panMode && !s && o.reset(), void (s ? e.stop() : e.start())
            );
        }
...
class Oe extends g {
                        ...
                        const t = Math.abs(i.current.f),
                            e =
                                t < 1
                                    ...
                                    : Math.max(
                                          0.5,
                                          Math.min(1, 1 - (t / i.contentRect.fitHeight) * 1.5)
                                      );
            ...
            : ((this.pwt = r),
              ...
              t.defaultPrevented ||
                  ('close' === n
                      ? (t.preventDefault(), this.close(t))
                      : 'slide' === n &&
                        (i(e) || (t.preventDefault(), this[a > 0 ? 'prev' : 'next']()))));
    }
    onScroll() {
    ...
    onKeydown(t) {
        ...
        if (
            ('Tab' === t.key ? P(this.container, ae) : S(this.container, ae),
    ...
    stop(t) {
        t &&
            t.dispatchEvent(
                new CustomEvent('animationend', { bubbles: !1, cancelable: !0, currentTarget: t })
            );
    }
    setContent(t, e = '', i = !0) {
        ...
        if (
            (E(e)
                ? (o = e)
                : ((o = n(e + '')),
                  E(o) || ((o = document.createElement('div')), (o.innerHTML = e + ''))),
    ...
    endIdle() {
        this.clearIdle(),
            this.idle &&
                !this.isClosing() &&
                ((this.idle = !1), S(this.container, 'is-idle'), this.emit('endIdle'));
    }
    resetIdle() {
    ...
    static unbind(t, e) {
        ...
        s && n && s.delete(n),
            (n && s) || (Oe.openers.delete(i), i.removeEventListener('click', Oe.fromEvent));
    }
    static destroy() {
        let t;
